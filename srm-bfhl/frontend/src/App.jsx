...
export default function App() {
  ...
  const processNetworkRequest = async (edgeList) => {
    ...
    try {
      ...
      setSystemAlert(failure.response?.data?.error || failure.message || 'System fault encountered during analysis.');
    } finally {
  ...
  return (
    <div className="main-wrapper">
      ...
      <p className="tagline">Advanced hierarchical mapping and structural diagnostics</p>
      ...
      {analysisOutcome && (
        <>
          ...
          <div style={{ marginTop: '2.5rem' }}>
            <h2 style={{ marginBottom: '1.5rem', borderBottom: '2px solid var(--card-border)', paddingBottom: '0.5rem' }}>
